...
const getRandomInt = (min: number, max: number) => Math.ceil(getRandomFloat(min, max))
...
export const SvgStarsBackground = () => {
    ...
    for (let i = 0; i < starsAmount; i++) {
        ...
        stars.push({
            speed,
            c: <circle cx="50%" cy="50%" r="1" opacity={0} fill='var(--text-accent)'>
            <animate
                attributeName="r"
                begin={begin}
                dur={duration}
